...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.dispatchLogger = exports.connect = exports.Provider = exports.compose = exports.applyMiddleware = exports.bindActionCreators = exports.combineReducers = exports.createStore = undefined;
	...
	console.log('dispatchLogger', _seeduxLogger2['default']);
	/*
...
/***/ function(module, exports, __webpack_require__) {
	...
	var listenerFlag = false; /* global chrome */
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (e, t) {
	  ...
	  var t,
	      n,
	      r = [];if ((typeof global === "undefined" ? "undefined" : _typeof(global)) === "object" && global) {
	    t = global;
	    ...
	    Object.defineProperty(this, "kind", { value: e, enumerable: true });if (t && t.length) {
	      Object.defineProperty(this, "path", { value: t, enumerable: true });
	    }
	  }function f(e, t, n) {
	    f.super_.call(this, "E", e);Object.defineProperty(this, "lhs", { value: t, enumerable: true });Object.defineProperty(this, "rhs", { value: n, enumerable: true });
	  }i(f, a);function l(e, t) {
	    l.super_.call(this, "N", e);Object.defineProperty(this, "rhs", { value: t, enumerable: true });
	  }i(l, a);function u(e, t) {
	    u.super_.call(this, "D", e);Object.defineProperty(this, "lhs", { value: t, enumerable: true });
	  }i(u, a);function s(e, t, n) {
	    s.super_.call(this, "A", e);Object.defineProperty(this, "index", { value: t, enumerable: true });Object.defineProperty(this, "item", { value: n, enumerable: true });
	  }i(s, a);function o(e, t, n) {
	    var r = e.slice((n || t) + 1 || e.length);e.length = t < 0 ? e.length + t : t;e.push.apply(e, r);return e;
	  }function c(e) {
	    var t = typeof e === "undefined" ? "undefined" : _typeof(e);if (t !== "object") {
	      return t;
	    }if (e === Math) {
	      return "math";
	    } else if (e === null) {
	      ...
	      return "date";
	    } else if (typeof e.toString !== "undefined" && /^\/.*\//.test(e.toString())) {
	      return "regexp";
	    }return "object";
	  }function h(t, n, r, i, a, p, b) {
	    a = a || [];var d = a.slice(0);if (typeof p !== "undefined") {
	      if (i) {
	        if (typeof i === "function" && i(d, p)) {
	          return;
	        } else if ((typeof i === "undefined" ? "undefined" : _typeof(i)) === "object") {
	          if (i.prefilter && i.prefilter(d, p)) {
	            return;
	          }if (i.normalize) {
	            var y = i.normalize(d, p, t, n);if (y) {
	              t = y[0];n = y[1];
	            }
	          }
	        }
	      }d.push(p);
	    }if (c(t) === "regexp" && c(n) === "regexp") {
	      t = t.toString();n = n.toString();
	    }var v = typeof t === "undefined" ? "undefined" : _typeof(t);var g = typeof n === "undefined" ? "undefined" : _typeof(n);if (v === "undefined") {
	      if (g !== "undefined") {
	        r(new l(d, n));
	      }
	    } else if (g === "undefined") {
	      ...
	      r(new f(d, t, n));
	    } else if (Object.prototype.toString.call(t) === "[object Date]" && Object.prototype.toString.call(n) === "[object Date]" && t - n !== 0) {
	      r(new f(d, t, n));
	    } else if (v === "object" && t !== null && n !== null) {
	      b = b || [];if (b.indexOf(t) < 0) {
	        b.push(t);if (Array.isArray(t)) {
	          var k,
	              m = t.length;for (k = 0; k < t.length; k++) {
	            if (k >= n.length) {
	              r(new s(d, k, new u(e, t[k])));
	            } else {
	              h(t[k], n[k], r, i, d, k, b);
	            }
	          }while (k < n.length) {
	            r(new s(d, k, new l(e, n[k++])));
	          }
	        } else {
	          var j = Object.keys(t);var w = Object.keys(n);j.forEach(function (a, f) {
	            var l = w.indexOf(a);if (l >= 0) {
	              h(t[a], n[a], r, i, d, a, b);w = o(w, l);
	            } else {
	              h(t[a], e, r, i, d, a, b);
	            }
	      ...
	      if (!(v === "number" && isNaN(t) && isNaN(n))) {
	        r(new f(d, t, n));
	      }
	    }
	  }function p(t, n, r, i) {
	    i = i || [];h(t, n, function (e) {
	      if (e) {
	        i.push(e);
	      }
	    }, r);return i.length ? i : e;
	  }function b(e, t, n) {
	    if (n.path && n.path.length) {
	      var r = e[t],
	          i,
	          a = n.path.length - 1;for (i = 0; i < a; i++) {
	        r = r[n.path[i]];
	      }switch (n.kind) {case "A":
	          b(r[n.path[i]], n.index, n.item);break;case "D":
	          delete r[n.path[i]];break;case "E":case "N":
	          r[n.path[i]] = n.rhs;break;}
	    } else {
	      switch (n.kind) {case "A":
	          b(e[t], n.index, n.item);break;case "D":
	          e = o(e, t);break;case "E":case "N":
	          e[t] = n.rhs;break;}
	    }return e;
	  }function d(e, t, n) {
	    if (e && t && n && n.kind) {
	      var r = e,
	          i = -1,
	          a = n.path ? n.path.length - 1 : 0;while (++i < a) {
	        if (typeof r[n.path[i]] === "undefined") {
	          r[n.path[i]] = typeof n.path[i] === "number" ? [] : {};
	        }r = r[n.path[i]];
	      }switch (n.kind) {case "A":
	          b(n.path ? r[n.path[i]] : r, n.index, n.item);break;case "D":
	          delete r[n.path[i]];break;case "E":case "N":
	          r[n.path[i]] = n.rhs;break;}
	    }
	  }function y(e, t, n) {
	    if (n.path && n.path.length) {
	      var r = e[t],
	        ...
	        r = r[n.path[i]];
	          ...
	          y(r[n.path[i]], n.index, n.item);break;case "D":
	          r[n.path[i]] = n.lhs;break;case "E":
	          r[n.path[i]] = n.lhs;break;case "N":
	          delete r[n.path[i]];break;}
	    } else {
	      switch (n.kind) {case "A":
	          y(e[t], n.index, n.item);break;case "D":
	    ...
	    if (e && t && n && n.kind) {
	      var r = e,
	          i,
	          a;a = n.path.length - 1;for (i = 0; i < a; i++) {
	        if (typeof r[n.path[i]] === "undefined") {
	          r[n.path[i]] = {};
	        }r = r[n.path[i]];
	      }switch (n.kind) {case "A":
	  ...
	  }Object.defineProperties(p, { diff: { value: p, enumerable: true }, observableDiff: { value: h, enumerable: true }, applyDiff: { value: g, enumerable: true }, applyChange: { value: d, enumerable: true }, revertChange: { value: v, enumerable: true }, isConflict: { value: function value() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function combineReducers(reducers) {
	  ...
	  _seeduxExtractor.seedux.reducersExtractor(seeduxObj);
	  ...
	  return function combination() {
	    ...
	    // seedux
	    if (action && action.type === 'seedux_UNDO') {
	      console.log('UNDO-ING...');
	      var theNewPresent = history.pop();
	      future.unshift(state);
	      console.log('Past: ', history, 'Future: ', future);
	      return theNewPresent;
	    } else if (action && action.type === 'seedux_REDO') {
	      console.log('REDO-ING...');
	      var _theNewPresent = future.shift();
	      history.push(state);
	      console.log('Past: ', history, 'Future: ', future);
	      return _theNewPresent;
	    } else {
...
/***/ function(module, exports) {
	...
	*/
	...
	seedux.uiExtractor = function (ui) {
	  console.log('Extracting ui...');
	  var uiObj = {};
	  var uiName = ui[0];
	  var uiPropNames = ui[1];
	  var uiNameNode = new Node(uiName);
	  uiNameNode.children = [];
	  uiPropNames.forEach(function (p) {
	    return uiNameNode.children.push(new Node(p));
	  });
	...
	*/
	...
	seedux.reducersExtractor = function (reducers) {
	  ...
	  if (strReducers.includes('switch')) {
	    ...
	    reducerCases = strReducers.split('action.type').slice(1).map(function (subStr) {
	      ...
	      return subStr = subStr.slice(0, subStr.indexOf(')'));
	    });
	...
	function assembleReducerNodes(headNode, reducers, reducerNames) {
	  var reducerCases = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];

	  reducerNames.forEach(function (reducer, i) {
	    var reducerNode = new Node(reducer);
	    reducerNode.children = [];
	    if (reducerCases[i]) {
	      reducerCases.forEach(function (c) {
	...
	*
	* @param {Object} actionCreators is an object whose keys are action creator function names
	* (value: string) and whose values are stringified action creator function definitions (value: string).
	* Turns an object consisting of keys that are action creator names and values that are stringified
	* action creator function definitions passed into seedux.actionCreatorsExtractor, which occurs
	...
	*/
	...
	seedux.actionCreatorsExtractor = function (actionCreators) {
	  console.log('Extracting Actions...!');
	  var headNode = new Node('Action Creators');
	  var actionCreatorNames = Object.keys(actionCreators);
	  var strActionCreators = JSON.stringify(actionCreators);
	  var actionTypes = strActionCreators.split('type:').map(function (t) {
	    return t.match(/['"]\w*['",]/gi);
	  }, '').slice(1);
	  headNode.children = [];
	...
	module.exports = { seedux: seedux, Node: Node };
...
/***/ function(module, exports, __webpack_require__) {
	...
	function bindActionCreators(actionCreators, dispatch) {
	  ...
	  _seeduxExtractor.seedux.actionCreatorsExtractor(seeduxObj);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _seeduxExtractor = __webpack_require__(213);
	...
	function connect(mapStateToProps, mapDispatchToProps, mergeProps) {
	  ...
	  return function wrapWithConnect(WrappedComponent) {
	    ...
	    var props = _typeof(WrappedComponent.propTypes) === 'object' ? Object.keys(WrappedComponent.propTypes) : [];

	    _seeduxExtractor.seedux.uiExtractor([ui, props]);
